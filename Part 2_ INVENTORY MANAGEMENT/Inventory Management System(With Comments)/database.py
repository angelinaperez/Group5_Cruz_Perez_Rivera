...
#create query - insert product variable that was passed into inventory table and product table
...
#create query - using delete query for delete button
...
#create query - using insert query specifically for addstock table
